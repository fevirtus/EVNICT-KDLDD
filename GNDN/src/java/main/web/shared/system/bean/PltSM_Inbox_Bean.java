...
@ManagedBean
@RequestScoped
public class PltSM_Inbox_Bean extends BasePortletBean implements Serializable {
    ...
    public static boolean createInboxMsg(Sm_Inbox s_Data) {
        try {
            ...
            if (kc == null || kc.getGenStatus() != 0) //Không thành công
            {
                ...
                commmonPage.showErrorFromGenKey(kc, PltSM_Inbox_Bean.class.getSimpleName());
                return false;
            }
