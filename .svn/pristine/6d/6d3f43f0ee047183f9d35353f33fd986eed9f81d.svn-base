...
@ManagedBean
@RequestScoped
public class PltSM_Shortcut_Bean extends BasePortletBean implements Serializable {
...
//{{<editor-fold defaultstate="collapsed" desc="Portlet BulletinBoard: PBB">
    ...
    public String getpbbViewAttach() {
        ...
        String s = m_rf.getMessage("BBViewDownload") + ": " + m_pbbCurrentBB.getAttachCount();
        return s;
    }
    ...
    public static boolean createInboxMsg(Sm_Inbox s_Data) {
        try {
            ...
            if (kc == null || kc.getGenStatus() != 0) //Không thành công
            {
                ...
                commmonPage.showErrorFromGenKey(kc, PltSM_Shortcut_Bean.class.getSimpleName());
                return false;
            }
            ...
            ex.printStackTrace();
            //WebTools.showErrorFromException(ex, PltShortcutMng.class.getSimpleName());
        }
        return false;
    }
