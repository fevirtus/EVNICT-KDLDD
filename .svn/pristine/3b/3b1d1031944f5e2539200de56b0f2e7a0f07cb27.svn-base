...
@ManagedBean
@ViewScoped
public class ChonDonViQuanLyBean extends BasePageCommon implements Serializable {
    ...
    public void onCollapseAll() {
        setExpandedRecursively(rootTreeNode, false);
    }

    public void onExpandAll() {
        setExpandedRecursively(rootTreeNode, true);
    }
