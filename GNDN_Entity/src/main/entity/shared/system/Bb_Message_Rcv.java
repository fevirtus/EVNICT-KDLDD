...
public class Bb_Message_Rcv implements Serializable {
...
//    private Bb_Lst_Receivertype bbLstReceivertype;
    ...
    public Bb_Message_Rcv() {
    }

    public Bb_Message_Rcv(Bb_Message_RcvPK bb_Message_RcvPK) {
        this.bb_Message_RcvPK = bb_Message_RcvPK;
    }

    public Bb_Message_Rcv(String bbmid, String bbrcvtypeid, String rcvid) {
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Bb_Message_Rcv)) {
            return false;
        }
        Bb_Message_Rcv other = (Bb_Message_Rcv) object;
